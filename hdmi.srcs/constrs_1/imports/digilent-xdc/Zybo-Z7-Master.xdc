...
set_property -dict { PACKAGE_PIN D20   IOSTANDARD TMDS_33     } [get_ports { dataB_n }]; #IO_L4N_T0_35 Sch=hdmi_tx_n[0]
set_property -dict { PACKAGE_PIN D19   IOSTANDARD TMDS_33     } [get_ports { dataB_p }]; #IO_L4P_T0_35 Sch=hdmi_tx_p[0]
set_property -dict { PACKAGE_PIN B20   IOSTANDARD TMDS_33     } [get_ports { dataG_n }]; #IO_L1N_T0_AD0N_35 Sch=hdmi_tx_n[1]
set_property -dict { PACKAGE_PIN C20   IOSTANDARD TMDS_33     } [get_ports { dataG_p }]; #IO_L1P_T0_AD0P_35 Sch=hdmi_tx_p[1]
set_property -dict { PACKAGE_PIN A20   IOSTANDARD TMDS_33     } [get_ports { dataR_n }]; #IO_L2N_T0_AD8N_35 Sch=hdmi_tx_n[2]
set_property -dict { PACKAGE_PIN B19   IOSTANDARD TMDS_33     } [get_ports { dataR_p }]; #IO_L2P_T0_AD8P_35 Sch=hdmi_tx_p[2]
...
#Pmod Header JC                                                                                                                  
#set_property -dict { PACKAGE_PIN V15   IOSTANDARD LVCMOS33 PULLUP TRUE    } [get_ports { jc[0] }]; #IO_L10P_T1_34 Sch=jc_p[1]   			 
#set_property -dict { PACKAGE_PIN W15   IOSTANDARD LVCMOS33 PULLUP TRUE    } [get_ports { jc[1] }]; #IO_L10N_T1_34 Sch=jc_n[1]		     
#set_property -dict { PACKAGE_PIN T11   IOSTANDARD LVCMOS33 PULLUP TRUE    } [get_ports { scl }]; #IO_L1P_T0_34 Sch=jc_p[2]              
#set_property -dict { PACKAGE_PIN T10   IOSTANDARD LVCMOS33 PULLUP TRUE  } [get_ports { sda }]; #IO_L1N_T0_34 Sch=jc_n[2]
#set_property -dict { CLOCK_DEDICATED_ROUTE FALSE } [get_nets {scl_IOBUF_inst/O}];             
...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 PULLUP TRUE  } [get_ports { scl }]; #IO_L1P_T0_34 Sch=jc_p[2]              
set_property -dict { PACKAGE_PIN H15   IOSTANDARD LVCMOS33 PULLUP TRUE  } [get_ports { sda }]; #IO_L1N_T0_34 Sch=jc_n[2]                 
